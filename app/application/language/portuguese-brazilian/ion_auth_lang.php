...
$lang['email_activate_heading']    			= 'Ative sua conta para <strong>%s</strong>';
$lang['email_activate_subheading'] 			= 'Por favor, clique neste link para <strong>%s</strong>.';
$lang['email_activate_link']       			= 'Ative sua conta';

// Forgot Password Email
$lang['email_forgotten_password_subject']   = 'Esqueci a senha';
$lang['email_forgot_password_heading']    	= 'Redefinido a senha para <strong>%s</strong>';
$lang['email_forgot_password_subheading'] 	= 'Por favor, clique neste link para <strong>%s</strong>.';
$lang['email_forgot_password_link']       	= 'Redefina sua senha';

// New Password Email
$lang['email_new_password_subject']         = 'Nova senha';
$lang['email_new_password_heading']    		= 'Nova senha para <strong>%s</strong>';
$lang['email_new_password_subheading'] 		= 'Sua senha foi redefinida para: <strong>%s</strong>';
